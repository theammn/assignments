...
def fetch_ncbi_records(term, number):
    ...
    # Search the term in NCBI nucleotide database
    search_handle = Entrez.esearch(db="nucleotide", term=term, idtype="acc", retmax=number)
    ...
    for index, record_id in enumerate(ids):
        fetch_handle = Entrez.efetch(db="nucleotide", id=record_id, rettype="gb", retmode="text")
